//
//  IPDContentHorizontalPagePlatformView.m
//  ipdsdk_flutter
//
...
@interface IPDContentHorizontalPagePlatformView()<FlutterStreamHandler>
...
@implementation IPDContentHorizontalPagePlatformView
- (instancetype)initWithFrame:(CGRect)frame
    ...
    if (self = [super init]) {
        ...
        //强持有避免立刻释放
        self.contentPage = [[IPDHorizontalFeedPage alloc]initWithPlacementId:adId];
...
@interface IPDContentHorizontalPagePlatformViewFactory()
@property (nonatomic, strong) NSObject<FlutterPluginRegistrar> *registrar;
@end

@implementation IPDContentHorizontalPagePlatformViewFactory
...
- (NSObject<FlutterPlatformView> *)createWithFrame:(CGRect)frame viewIdentifier:(int64_t)viewId arguments:(id)args {
    return [[IPDContentHorizontalPagePlatformView alloc] initWithFrame:frame viewIdentifier:viewId arguments:args registrar:_registrar];
}
@end
