...
@interface IPDContentPageVC ()

@end

@implementation IPDContentPageVC
...
- (void)viewDidLoad {
    ...
    NSLog(@"IPDKSContentPage===========%@",NSClassFromString(@"IPDKSContentPage"));
    NSLog(@"IPDKSSplashAd===========%@",NSClassFromString(@"IPDKSSplashAd"));
