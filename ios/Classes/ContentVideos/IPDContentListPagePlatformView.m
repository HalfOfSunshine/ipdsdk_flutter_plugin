//
//  IPDContentListPagePlatformView.m
//  ipdsdk_flutter
//
...
@interface IPDContentListPagePlatformView()<FlutterStreamHandler>
...
@implementation IPDContentListPagePlatformView
- (instancetype)initWithFrame:(CGRect)frame
    ...
    if (self = [super init]) {
        ...
        //强持有避免立刻释放
        self.contentPage = [[IPDContentPage alloc]initWithPlacementId:adId];
...
@interface IPDContentListPagePlatformViewFactory()
@property (nonatomic, strong) NSObject<FlutterPluginRegistrar> *registrar;
@end

@implementation IPDContentListPagePlatformViewFactory
...
- (NSObject<FlutterPlatformView> *)createWithFrame:(CGRect)frame viewIdentifier:(int64_t)viewId arguments:(id)args {
    return [[IPDContentListPagePlatformView alloc] initWithFrame:frame viewIdentifier:viewId arguments:args registrar:_registrar];
}
@end
